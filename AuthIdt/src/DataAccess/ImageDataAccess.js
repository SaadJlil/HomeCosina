...
class ImageDataAccess{
    ...
    static async StoreImage(Id, EncodedImage, isThumbnail = false){
        try{

            const b2 = ImageDataAccess.b2;
            const folderName = b2.userFolder + ((isThumbnail) ? b2.thumbnailFolder: b2.mainFolder);
    ...
    static async DeleteImage(Id){
        try{
            ...
            const b2 = ImageDataAccess.b2;
            const folderName = b2.userFolder;
